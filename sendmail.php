...
if (isset($_POST['btnSend'])) {
    ...
    if ((!empty($nome)) && (!empty($email)) && (!empty($telefone)) && (!empty($assunto)) && (!empty($mensagem))) {
        ...
        $email_remetente = "teste@tagsmarketingdigital.com.br"; // deve ser uma conta de email do seu dominio 
        $email_destinatario = "teste@tagsmarketingdigital.com.br"; // email que receberá as mensagens
